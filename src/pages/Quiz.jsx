...
const MAJORS = [
  ...
  { name: "Computer Science", salaryRange: "$75k–$160k", jobOutlook: "Excellent",
    ...
    aiImpact: { level: "accelerates", summary: "CS graduates who understand AI are commanding 40% salary premiums — AI is a tool that makes them dramatically more productive, not a replacement." } },
  { name: "Mechanical Engineering", salaryRange: "$70k–$130k", jobOutlook: "Strong",
    ...
    aiImpact: { level: "changing", summary: "AI is automating routine design tasks, but mechanical engineers who use AI simulation tools are solving problems 10x faster and are in higher demand." } },
  { name: "Electrical Engineering", salaryRange: "$75k–$140k", jobOutlook: "Strong",
    ...
    aiImpact: { level: "accelerates", summary: "AI chip design and embedded AI systems are creating entirely new specializations — EE graduates with AI knowledge are among the most sought-after in tech." } },
  { name: "Data Science", salaryRange: "$80k–$165k", jobOutlook: "Excellent",
    ...
    aiImpact: { level: "accelerates", summary: "AI has supercharged this field — data scientists who can build and interpret ML models earn 30-50% more than those who cannot." } },
  { name: "Mathematics / Statistics", salaryRange: "$65k–$140k", jobOutlook: "Strong", wild: true,
    ...
    aiImpact: { level: "accelerates", summary: "Statisticians and mathematicians underpin every AI system — demand for people who truly understand the math behind AI has never been higher." } },
  { name: "Physics", salaryRange: "$60k–$130k", jobOutlook: "Stable", wild: true,
    ...
    aiImpact: { level: "accelerates", summary: "Physics graduates are disproportionately hired by AI labs — the analytical rigor transfers directly to machine learning research." } },
  { name: "Materials Science", salaryRange: "$70k–$120k", jobOutlook: "Growing", wild: true,
    ...
    aiImpact: { level: "changing", summary: "AI is accelerating materials discovery, but human expertise in synthesis and testing remains essential — the field is growing, not shrinking." } },
  { name: "Civil Engineering", salaryRange: "$65k–$120k", jobOutlook: "Strong",
    ...
    aiImpact: { level: "changing", summary: "AI is handling routine structural calculations, freeing civil engineers to focus on complex design decisions and project leadership where human judgment is irreplaceable." } },
  { name: "Aerospace Engineering", salaryRange: "$75k–$135k", jobOutlook: "Strong", wild: true,
    ...
    aiImpact: { level: "accelerates", summary: "AI-driven simulation and autonomous systems are expanding aerospace — graduates who understand both are working on some of the most exciting engineering problems alive." } },
  { name: "Chemical Engineering", salaryRange: "$80k–$160k", jobOutlook: "Strong",
    careers: ["Process Engineer","Petroleum Engineer","Pharmaceutical Engineer","Biotech Researcher"],
    tags: ["Building or fixing things","Solving puzzles or math","Math","Science (bio, chem, physics)","Hands-on — making, building, doing","Technical know-how","Healthcare and disease","Climate and the environment","Job stability and security"],
    aiImpact: { level: "accelerates", summary: "AI-driven molecular simulation and process optimization are making chemical engineers dramatically more productive — it's one of the highest-paying engineering degrees with no sign of slowing." } },
  { name: "Chemistry", salaryRange: "$60k–$130k", jobOutlook: "Stable", wild: true,
    careers: ["Chemist","Pharmaceutical Researcher","Materials Scientist","Quality Control Specialist"],
    tags: ["Researching and learning new topics","Science (bio, chem, physics)","Analytical — researching and solving","Hands-on — making, building, doing","Continuous learning","Healthcare and disease","Climate and the environment","Noticing details others miss"],
    aiImpact: { level: "accelerates", summary: "AI is accelerating drug discovery and materials research, making chemists who can work alongside computational tools among the most valuable scientists in pharma and biotech right now." } },
  { name: "Cybersecurity", salaryRange: "$75k–$155k", jobOutlook: "Excellent", wild: true,
    ...
    aiImpact: { level: "accelerates", summary: "AI creates new attack vectors while also powering defenses — cybersecurity professionals are more essential than ever, and AI knowledge is a major advantage." } },
  ...
  { name: "Nursing", salaryRange: "$65k–$120k", jobOutlook: "Excellent",
    ...
    aiImpact: { level: "accelerates", summary: "AI is handling documentation and monitoring, freeing nurses for the human care that only they can provide — nursing is one of the most AI-resilient careers that exists." } },
  { name: "Biology / Pre-Med", salaryRange: "$60k–$200k+", jobOutlook: "Strong",
    ...
    aiImpact: { level: "accelerates", summary: "AI is transforming drug discovery and diagnostics, but physicians and researchers who understand both biology and AI tools are the most valuable people in medicine right now." } },
  { name: "Public Health", salaryRange: "$55k–$110k", jobOutlook: "Growing", wild: true,
    ...
    aiImpact: { level: "accelerates", summary: "AI is revolutionizing disease tracking and intervention design — public health professionals who can work with AI tools are leading the most impactful health initiatives." } },
  { name: "Kinesiology / Exercise Science", salaryRange: "$45k–$95k", jobOutlook: "Growing", wild: true,
    ...
    aiImpact: { level: "accelerates", summary: "AI-powered wearables and movement analysis are creating new tools for physical therapists and trainers — graduates who embrace these tools will work more effectively with clients." } },
  { name: "Nutrition / Dietetics", salaryRange: "$50k–$90k", jobOutlook: "Growing", wild: true,
    ...
    aiImpact: { level: "changing", summary: "AI nutrition apps exist, but personalized clinical dietetics requires human assessment and relationship-building that no app can replicate." } },
  { name: "Neuroscience", salaryRange: "$60k–$130k", jobOutlook: "Growing", wild: true,
    ...
    aiImpact: { level: "accelerates", summary: "Neuroscience and AI are deeply intertwined — brain-computer interfaces and AI-powered diagnostics are creating careers that did not exist 5 years ago." } },
  ...
  { name: "Psychology", salaryRange: "$50k–$110k", jobOutlook: "Strong",
    ...
    aiImpact: { level: "changing", summary: "AI can screen and triage, but therapy and deep human support require human connection — psychologists who use AI tools for assessment will be more effective, not replaced." } },
  { name: "Sociology", salaryRange: "$45k–$90k", jobOutlook: "Stable", wild: true,
    ...
    aiImpact: { level: "changing", summary: "AI can analyze social data at scale, but interpreting what it means for human communities requires sociological training that AI cannot replicate." } },
  { name: "Anthropology", salaryRange: "$45k–$90k", jobOutlook: "Stable", wild: true,
    ...
    aiImpact: { level: "changing", summary: "AI is a new tool for analyzing cultural data, but fieldwork, ethnography, and human interpretation remain entirely in the hands of anthropologists." } },
  { name: "Linguistics", salaryRange: "$50k–$110k", jobOutlook: "Growing", wild: true,
    ...
    aiImpact: { level: "accelerates", summary: "Every large language model is built on linguistics — computational linguists are among the most in-demand specialists in AI development right now." } },
  { name: "History", salaryRange: "$45k–$85k", jobOutlook: "Stable",
    ...
    aiImpact: { level: "changing", summary: "AI can surface and organize historical records at unprecedented scale, but the interpretation and meaning-making that historians do requires human expertise." } },
  { name: "Philosophy", salaryRange: "$45k–$95k", jobOutlook: "Stable", wild: true,
    ...
    aiImpact: { level: "accelerates", summary: "AI ethics is one of the fastest-growing fields in tech — philosophers with analytical training are being hired by major AI companies to work on questions only they are equipped to tackle." } },
  { name: "English / Communications", salaryRange: "$45k–$95k", jobOutlook: "Stable",
    ...
    aiImpact: { level: "changing", summary: "AI can generate drafts, but strategic communication, narrative judgment, and audience understanding are skills that remain deeply human and highly valued." } },
  { name: "Political Science / Pre-Law", salaryRange: "$55k–$160k", jobOutlook: "Stable",
    ...
    aiImpact: { level: "changing", summary: "AI is automating legal research and document review, but courtroom advocacy, political judgment, and complex negotiation remain firmly human domains." } },
  { name: "International Relations", salaryRange: "$50k–$120k", jobOutlook: "Stable", wild: true,
    ...
    aiImpact: { level: "changing", summary: "AI is a tool for analyzing geopolitical data, but diplomacy, cultural intelligence, and relationship-building cannot be automated." } },
  ...
  { name: "Business Administration", salaryRange: "$55k–$140k", jobOutlook: "Strong",
    ...
    aiImpact: { level: "changing", summary: "AI is reshaping operations and analytics, but strategic leadership, stakeholder management, and organizational change require human judgment at every level." } },
  { name: "Finance / Economics", salaryRange: "$70k–$180k", jobOutlook: "Strong",
    ...
    aiImpact: { level: "automating", summary: "AI is handling routine analysis and trading — finance professionals who focus on complex deal-making, client relationships, and strategic judgment are insulated, but entry-level roles are shrinking." } },
  { name: "Marketing", salaryRange: "$50k–$120k", jobOutlook: "Strong",
    ...
    aiImpact: { level: "changing", summary: "AI is handling ad targeting and content drafts, but brand strategy, creative direction, and cultural insight are skills that command premium salaries and resist automation." } },
  { name: "Supply Chain Management", salaryRange: "$60k–$120k", jobOutlook: "Growing", wild: true,
    ...
    aiImpact: { level: "accelerates", summary: "AI-driven logistics optimization is one of the hottest areas in business — supply chain professionals who understand these systems are being promoted faster than ever." } },
  { name: "Accounting", salaryRange: "$55k–$115k", jobOutlook: "Strong",
    ...
    aiImpact: { level: "automating", summary: "AI is automating bookkeeping and basic tax preparation — CPAs who move into advisory, strategy, and complex tax work are thriving, but routine accounting roles are under pressure." } },
  ...
  { name: "Graphic Design / Digital Media", salaryRange: "$45k–$100k", jobOutlook: "Stable",
    ...
    aiImpact: { level: "changing", summary: "AI image tools are changing the industry, but art direction, brand strategy, and creative judgment remain human — designers who master AI tools as part of their workflow are more productive and competitive." } },
  { name: "Game Design", salaryRange: "$55k–$120k", jobOutlook: "Growing", wild: true,
    ...
    aiImpact: { level: "accelerates", summary: "AI is being integrated into every aspect of game development — designers who understand AI-driven procedural generation and NPC behavior are working on the industry's most exciting projects." } },
  { name: "Architecture", salaryRange: "$55k–$110k", jobOutlook: "Stable", wild: true,
    ...
    aiImpact: { level: "changing", summary: "AI is transforming parametric design and visualization, but the spatial reasoning, client relationships, and site judgment that architects bring cannot be automated." } },
  { name: "Film / Media Production", salaryRange: "$40k–$100k", jobOutlook: "Stable", wild: true,
    ...
    aiImpact: { level: "changing", summary: "AI is handling editing assistance and VFX, but storytelling, direction, and creative vision are distinctly human — filmmakers who embrace AI tools will work faster and more creatively." } },
  { name: "Music", salaryRange: "$35k–$90k", jobOutlook: "Stable", wild: true,
    ...
    aiImpact: { level: "changing", summary: "AI can generate tracks, but live performance, original artistry, and music education are deeply human endeavors that audiences continue to value and pay for." } },
  ...
  { name: "Education / Teaching", salaryRange: "$45k–$85k", jobOutlook: "Strong",
    ...
    aiImpact: { level: "accelerates", summary: "AI tutoring tools are emerging, but teachers who use them to personalize learning for each student will be far more effective — teaching is about human relationship and mentorship, which AI cannot replace." } },
  { name: "Social Work", salaryRange: "$45k–$80k", jobOutlook: "Strong", wild: true,
    ...
    aiImpact: { level: "accelerates", summary: "AI is handling case documentation and risk screening, freeing social workers to spend more time on the human connection and advocacy that defines the profession." } },
  ...
  { name: "Environmental Science", salaryRange: "$50k–$100k", jobOutlook: "Growing",
    ...
    aiImpact: { level: "accelerates", summary: "AI climate modeling and satellite monitoring are making environmental scientists dramatically more effective — this is one of the fields where AI is most clearly a force multiplier." } },
  { name: "Urban Planning", salaryRange: "$55k–$100k", jobOutlook: "Growing", wild: true,
    ...
    aiImpact: { level: "accelerates", summary: "AI-powered city simulation and traffic modeling are giving urban planners new tools to design better cities — the field is growing as cities face unprecedented challenges." } },
  { name: "Agriculture / Food Science", salaryRange: "$45k–$95k", jobOutlook: "Stable", wild: true,
    ...
    aiImpact: { level: "accelerates", summary: "Precision agriculture and AI crop monitoring are transforming food production — graduates who understand both the science and the technology are leading a quiet revolution in how we grow food." } },

  // ── CRIMINAL JUSTICE & PUBLIC SERVICE ──
  { name: "Criminal Justice / Criminology", salaryRange: "$45k–$90k", jobOutlook: "Stable",
    careers: ["Law Enforcement Officer","Probation Officer","Crime Analyst","Forensic Specialist"],
    tags: ["Solving puzzles or math","Organizing plans and leading groups","Psychology / Sociology","History / Social Studies","Strategic — planning and leading","Making a difference","Justice and governance","Poverty and inequality","Staying calm and problem-solving","Noticing details others miss"],
    aiImpact: { level: "changing", summary: "AI predictive policing tools and forensic analysis software are reshaping criminal justice — professionals who understand both the technology and its ethical implications are in high demand." } },
  { name: "Public Administration", salaryRange: "$50k–$100k", jobOutlook: "Stable",
    careers: ["City Manager","Policy Analyst","Government Administrator","Nonprofit Director"],
    tags: ["Organizing plans and leading groups","History / Social Studies","Strategic — planning and leading","Making a difference","Justice and governance","Poverty and inequality","Education and opportunity","Motivating and inspiring others","Getting things organized and done"],
    aiImpact: { level: "changing", summary: "AI is improving government service delivery and data analysis, but public administrators who can navigate policy, ethics, and community stakeholders remain irreplaceable." } },

  // ── COMMUNICATIONS & MEDIA ──
  { name: "Journalism / Media Studies", salaryRange: "$40k–$90k", jobOutlook: "Changing", wild: true,
    careers: ["Reporter","Digital Editor","Multimedia Producer","Communications Director"],
    tags: ["Reading or writing","Making art, music, or content","English / Literature","Creative — imagining and expressing","Making a difference","Human creativity and culture","Explaining things clearly","Coming up with creative ideas","Justice and governance"],
    aiImpact: { level: "changing", summary: "AI is handling routine reporting and data journalism, but investigative work, source relationships, and editorial judgment are uniquely human — journalists who use AI tools are publishing more and earning more." } },
  { name: "Advertising / Public Relations", salaryRange: "$45k–$105k", jobOutlook: "Stable",
    careers: ["PR Specialist","Account Manager","Brand Strategist","Media Planner"],
    tags: ["Making art, music, or content","Talking with and helping people","Economics / Business","Creative — imagining and expressing","Coming up with creative ideas","Entrepreneurship","Motivating and inspiring others","Human creativity and culture","Explaining things clearly"],
    aiImpact: { level: "changing", summary: "AI is generating ad copy and targeting audiences, but creative strategy, crisis communication, and brand voice require human judgment that clients are not willing to hand to a machine." } },

  // ── INFORMATION TECHNOLOGY ──
  { name: "Information Technology", salaryRange: "$60k–$130k", jobOutlook: "Strong",
    careers: ["IT Manager","Systems Administrator","Cloud Engineer","Technical Support Lead"],
    tags: ["Building or fixing things","Solving puzzles or math","Computer Science / Tech","Hands-on — making, building, doing","Technical know-how","Job stability and security","Getting things organized and done","Technology and society"],
    aiImpact: { level: "accelerates", summary: "IT professionals who manage AI infrastructure and cloud systems are among the most in-demand workers in the economy — this is a field where AI creates more jobs than it eliminates." } },
  { name: "Management Information Systems", salaryRange: "$65k–$135k", jobOutlook: "Strong", wild: true,
    careers: ["Business Analyst","IT Project Manager","Systems Analyst","ERP Consultant"],
    tags: ["Solving puzzles or math","Organizing plans and leading groups","Computer Science / Tech","Economics / Business","Analytical — researching and solving","Strategic — planning and leading","Getting things organized and done","Technical know-how"],
    aiImpact: { level: "accelerates", summary: "MIS sits at the intersection of business and technology — graduates who understand AI systems and business processes are being hired to lead digital transformation at major companies." } },

  // ── HEALTH PROFESSIONS ──
  { name: "Pharmacy / Pharmaceutical Science", salaryRange: "$90k–$140k", jobOutlook: "Stable",
    careers: ["Pharmacist","Pharmaceutical Researcher","Clinical Pharmacist","Drug Development Specialist"],
    tags: ["Science (bio, chem, physics)","Researching and learning new topics","Analytical — researching and solving","Making a difference","Healthcare and disease","Job stability and security","Noticing details others miss","Continuous learning"],
    aiImpact: { level: "accelerates", summary: "AI drug discovery is transforming pharmaceutical research, but licensed pharmacists remain essential for patient care, drug interactions, and clinical oversight." } },
  { name: "Occupational Therapy", salaryRange: "$65k–$100k", jobOutlook: "Excellent",
    careers: ["Occupational Therapist","Rehabilitation Specialist","Pediatric OT","School-Based OT"],
    tags: ["Talking with and helping people","Science (bio, chem, physics)","Hands-on — making, building, doing","Social — collaborating and teaching","Making a difference","Healthcare and disease","Mental health and well-being","Making people feel heard","Staying calm and problem-solving"],
    aiImpact: { level: "accelerates", summary: "AI-powered adaptive devices and rehabilitation tools are giving OTs new ways to help patients recover — the human relationship at the core of OT is irreplaceable." } },
  { name: "Speech-Language Pathology", salaryRange: "$65k–$105k", jobOutlook: "Excellent", wild: true,
    careers: ["Speech-Language Pathologist","Clinical SLP","School SLP","Research Clinician"],
    tags: ["Talking with and helping people","Science (bio, chem, physics)","Psychology / Sociology","Social — collaborating and teaching","Making a difference","Healthcare and disease","Education and opportunity","Making people feel heard","Staying calm and problem-solving"],
    aiImpact: { level: "accelerates", summary: "AI speech analysis tools are helping SLPs diagnose and track patient progress with unprecedented precision — demand for qualified SLPs far exceeds supply and is growing." } },
  { name: "Healthcare Administration", salaryRange: "$65k–$130k", jobOutlook: "Strong",
    careers: ["Hospital Administrator","Health Systems Manager","Practice Manager","Healthcare Consultant"],
    tags: ["Organizing plans and leading groups","Economics / Business","Strategic — planning and leading","Making a difference","Healthcare and disease","Job stability and security","Getting things organized and done","Motivating and inspiring others"],
    aiImpact: { level: "accelerates", summary: "AI is transforming hospital operations and patient flow — healthcare administrators who understand health informatics and AI tools are being recruited aggressively." } },

  // ── INTERDISCIPLINARY ──
  { name: "Liberal Arts / General Studies", salaryRange: "$40k–$85k", jobOutlook: "Stable",
    careers: ["Operations Coordinator","Marketing Analyst","Graduate School","Nonprofit Manager"],
    tags: ["Reading or writing","Researching and learning new topics","History / Social Studies","Psychology / Sociology","Analytical — researching and solving","Creative — imagining and expressing","Making a difference","Explaining things clearly","Human creativity and culture","Education and opportunity"],
    aiImpact: { level: "changing", summary: "Liberal arts graduates are being hired by AI companies for their writing, critical thinking, and ethical reasoning skills — the ability to think across disciplines is more valuable than ever." } },
  { name: "Interdisciplinary Studies", salaryRange: "$45k–$95k", jobOutlook: "Stable", wild: true,
    careers: ["Innovation Consultant","Policy Researcher","Social Entrepreneur","UX Researcher"],
    tags: ["Researching and learning new topics","Solving puzzles or math","Reading or writing","Making a difference","Analytical — researching and solving","Creative — imagining and expressing","Technology and society","Human creativity and culture","Continuous learning"],
    aiImpact: { level: "accelerates", summary: "The most in-demand AI roles require people who can think across disciplines — interdisciplinary thinkers who combine technical understanding with humanistic judgment are exactly what the industry needs." } },

  // ── BUSINESS ADDITIONS ──
  { name: "Entrepreneurship", salaryRange: "$45k–$unlimited", jobOutlook: "Growing", wild: true,
    careers: ["Founder","Product Manager","Venture Associate","Business Developer"],
    tags: ["Organizing plans and leading groups","Economics / Business","Strategic — planning and leading","High earning potential","Entrepreneurship","Creative — imagining and expressing","Coming up with creative ideas","Motivating and inspiring others","Technology and society"],
    aiImpact: { level: "accelerates", summary: "AI has dramatically lowered the cost of starting a company — entrepreneurs who understand how to build with AI tools can build in weeks what used to take years and a full team." } },
  { name: "Human Resources Management", salaryRange: "$55k–$110k", jobOutlook: "Stable",
    careers: ["HR Manager","Talent Acquisition Specialist","Compensation Analyst","DEI Director"],
    tags: ["Talking with and helping people","Organizing plans and leading groups","Psychology / Sociology","Economics / Business","Social — collaborating and teaching","Making a difference","Making people feel heard","Getting things organized and done","Motivating and inspiring others"],
    aiImpact: { level: "changing", summary: "AI is automating resume screening and HR analytics, but the human judgment required for hiring decisions, conflict resolution, and culture-building remains firmly with HR professionals." } },
  { name: "Sports Management", salaryRange: "$45k–$110k", jobOutlook: "Growing", wild: true,
    careers: ["Athletic Director","Sports Agent","Event Manager","Marketing Director"],
    tags: ["Organizing plans and leading groups","Economics / Business","Strategic — planning and leading","Entrepreneurship","Motivating and inspiring others","Getting things organized and done","Prestige and recognition"],
    aiImpact: { level: "changing", summary: "AI analytics are transforming how teams draft players and strategize, creating new roles for sports management graduates who understand both the business and the data." } },

  // ── CREATIVE ADDITIONS ──
  { name: "Creative Writing", salaryRange: "$40k–$95k", jobOutlook: "Changing", wild: true,
    careers: ["Author","Content Strategist","Screenwriter","UX Writer"],
    tags: ["Reading or writing","Making art, music, or content","English / Literature","Creative — imagining and expressing","Creative freedom","Human creativity and culture","Coming up with creative ideas","Explaining things clearly"],
    aiImpact: { level: "changing", summary: "AI can generate text, but original voice, emotional depth, and authentic storytelling are distinctly human — writers who use AI as a drafting tool while bringing their unique perspective are thriving." } },
  { name: "Animation / Motion Graphics", salaryRange: "$50k–$110k", jobOutlook: "Growing", wild: true,
    careers: ["3D Animator","Motion Designer","VFX Artist","Game Artist"],
    tags: ["Making art, music, or content","Solving puzzles or math","Computer Science / Tech","Art / Music / Theater","Creative — imagining and expressing","Creative freedom","Coming up with creative ideas","Technology and society","Human creativity and culture"],
    aiImpact: { level: "changing", summary: "AI is generating background assets and basic animation, but character animation, creative direction, and storytelling through motion remain deeply human skills that studios are paying a premium for." } },

  // ── EDUCATION ADDITIONS ──
  { name: "Early Childhood Education", salaryRange: "$35k–$70k", jobOutlook: "Strong",
    careers: ["Preschool Teacher","Child Development Specialist","Program Director","Family Services Coordinator"],
    tags: ["Talking with and helping people","Social — collaborating and teaching","Making a difference","Education and opportunity","Mental health and well-being","Making people feel heard","Motivating and inspiring others","Staying calm and problem-solving"],
    aiImpact: { level: "accelerates", summary: "AI learning tools are emerging in early education, but early childhood development depends entirely on human attachment and relationship — this is one of the most AI-resilient careers available." } },
  { name: "Special Education", salaryRange: "$45k–$80k", jobOutlook: "Excellent",
    careers: ["Special Education Teacher","Behavior Specialist","Transition Coordinator","Inclusion Specialist"],
    tags: ["Talking with and helping people","Organizing plans and leading groups","Psychology / Sociology","Social — collaborating and teaching","Making a difference","Education and opportunity","Mental health and well-being","Making people feel heard","Staying calm and problem-solving"],
    aiImpact: { level: "accelerates", summary: "AI-powered adaptive learning tools are giving special education teachers new ways to personalize instruction — demand for qualified special education teachers far exceeds supply nationwide." } },

  // ── MARINE & ENVIRONMENTAL ADDITIONS ──
  { name: "Marine Biology", salaryRange: "$45k–$95k", jobOutlook: "Growing", wild: true,
    careers: ["Marine Biologist","Oceanographer","Conservation Scientist","Aquaculture Specialist"],
    tags: ["Exploring nature or the outdoors","Researching and learning new topics","Science (bio, chem, physics)","Analytical — researching and solving","Making a difference","Climate and the environment","Continuous learning","Noticing details others miss"],
    aiImpact: { level: "accelerates", summary: "AI ocean monitoring and satellite data analysis are giving marine biologists tools to study ecosystems at unprecedented scale — it's expanding the field, not replacing it." } },

  // ── APPLIED TECH ──
  { name: "Artificial Intelligence / Machine Learning", salaryRange: "$110k–$200k+", jobOutlook: "Excellent", wild: true,
    careers: ["ML Engineer","AI Researcher","Data Scientist","AI Product Manager"],
    tags: ["Solving puzzles or math","Math","Computer Science / Tech","Researching and learning new topics","Analytical — researching and solving","High earning potential","Continuous learning","Technology and society","Noticing details others miss"],
    aiImpact: { level: "accelerates", summary: "This is the field that is building AI itself — graduates with a dedicated AI/ML degree are commanding starting salaries over $150k and are being recruited before they graduate." } },
  { name: "Biomedical Engineering", salaryRange: "$70k–$140k", jobOutlook: "Excellent", wild: true,
    careers: ["Biomedical Engineer","Medical Device Designer","Clinical Engineer","Regulatory Affairs Specialist"],
    tags: ["Building or fixing things","Solving puzzles or math","Math","Science (bio, chem, physics)","Hands-on — making, building, doing","Making a difference","Healthcare and disease","Technical know-how","Continuous learning"],
    aiImpact: { level: "accelerates", summary: "AI is revolutionizing medical device design, diagnostics, and prosthetics — biomedical engineers who understand machine learning are at the frontier of the most exciting work in medicine." } },

  // ── APPLIED HEALTH TECHNOLOGY ──
  { name: "Radiologic Technology / Medical Imaging", salaryRange: "$55k–$95k", jobOutlook: "Strong",
    careers: ["Radiologic Technologist","MRI Technologist","CT Scan Specialist","Imaging Manager"],
    tags: ["Science (bio, chem, physics)","Hands-on — making, building, doing","Technical know-how","Making a difference","Healthcare and disease","Job stability and security","Noticing details others miss","Staying calm and problem-solving"],
    aiImpact: { level: "accelerates", summary: "AI diagnostic imaging tools are making radiologic technologists more accurate and efficient — the field is growing as AI augments rather than replaces human expertise in reading scans." } },
  { name: "Dental Hygiene", salaryRange: "$60k–$100k", jobOutlook: "Excellent",
    careers: ["Dental Hygienist","Oral Health Educator","Public Health Dental Specialist","Clinical Coordinator"],
    tags: ["Talking with and helping people","Science (bio, chem, physics)","Hands-on — making, building, doing","Making a difference","Healthcare and disease","Job stability and security","Making people feel heard","Noticing details others miss"],
    aiImpact: { level: "accelerates", summary: "AI cavity detection and oral health monitoring tools are being adopted in dental offices, but the hands-on patient care at the heart of dental hygiene cannot be automated." } },
  { name: "Medical Laboratory Science", salaryRange: "$55k–$90k", jobOutlook: "Strong",
    careers: ["Medical Lab Technologist","Clinical Lab Scientist","Blood Bank Specialist","Lab Manager"],
    tags: ["Researching and learning new topics","Science (bio, chem, physics)","Analytical — researching and solving","Hands-on — making, building, doing","Making a difference","Healthcare and disease","Job stability and security","Noticing details others miss"],
    aiImpact: { level: "accelerates", summary: "AI is automating routine lab processing, freeing medical lab scientists to focus on complex analysis and quality control — demand is strong and the field is AI-resilient." } },

  // ── ENGINEERING ADDITIONS ──
  { name: "Computer Engineering", salaryRange: "$85k–$160k", jobOutlook: "Excellent",
    careers: ["Hardware Engineer","Embedded Systems Engineer","FPGA Designer","Chip Architect"],
    tags: ["Building or fixing things","Solving puzzles or math","Math","Computer Science / Tech","Science (bio, chem, physics)","Hands-on — making, building, doing","Technical know-how","High earning potential","Noticing details others miss"],
    aiImpact: { level: "accelerates", summary: "AI chip design is one of the hottest areas in tech — computer engineers who understand both hardware and machine learning are being recruited by NVIDIA, Apple, and AMD at record salaries." } },
  { name: "Industrial Engineering", salaryRange: "$70k–$130k", jobOutlook: "Strong",
    careers: ["Industrial Engineer","Operations Research Analyst","Process Improvement Manager","Logistics Engineer"],
    tags: ["Solving puzzles or math","Organizing plans and leading groups","Math","Hands-on — making, building, doing","Strategic — planning and leading","Getting things organized and done","Technical know-how","Job stability and security","Noticing details others miss"],
    aiImpact: { level: "accelerates", summary: "Industrial engineers are the ones implementing AI and automation in factories and supply chains — far from being displaced, they are the professionals being hired to deploy these systems." } },

  // ── BUSINESS ADDITIONS ──
  { name: "Real Estate", salaryRange: "$50k–$150k+", jobOutlook: "Stable",
    careers: ["Real Estate Agent","Property Manager","Real Estate Analyst","Commercial Broker"],
    tags: ["Talking with and helping people","Organizing plans and leading groups","Economics / Business","Strategic — planning and leading","High earning potential","Entrepreneurship","Motivating and inspiring others","Getting things organized and done"],
    aiImpact: { level: "changing", summary: "AI property valuation and market analysis tools are changing how real estate professionals work, but client relationships, negotiation, and local market expertise remain deeply human." } },
  { name: "Hospitality Management", salaryRange: "$45k–$100k", jobOutlook: "Growing",
    careers: ["Hotel Manager","Event Planner","Restaurant General Manager","Tourism Director"],
    tags: ["Talking with and helping people","Organizing plans and leading groups","Economics / Business","Strategic — planning and leading","Making a difference","Motivating and inspiring others","Getting things organized and done","Staying calm and problem-solving"],
    aiImpact: { level: "changing", summary: "AI is handling reservations and personalization at scale, but the hospitality industry runs on human warmth and service recovery — management roles are growing as travel rebounds." } },
  { name: "Fashion / Retail Merchandising", salaryRange: "$40k–$90k", jobOutlook: "Stable", wild: true,
    careers: ["Fashion Buyer","Visual Merchandiser","Brand Manager","Retail Planner"],
    tags: ["Making art, music, or content","Organizing plans and leading groups","Economics / Business","Creative — imagining and expressing","Creative freedom","Coming up with creative ideas","Human creativity and culture","Getting things organized and done"],
    aiImpact: { level: "changing", summary: "AI trend forecasting and inventory management are reshaping retail, but creative direction, brand identity, and buyer relationships remain human-driven skills that command premium salaries." } },

  // ── LEGAL & PUBLIC SERVICE ──
  { name: "Paralegal / Legal Studies", salaryRange: "$45k–$80k", jobOutlook: "Stable",
    careers: ["Paralegal","Legal Assistant","Compliance Specialist","Court Researcher"],
    tags: ["Reading or writing","Solving puzzles or math","History / Social Studies","Analytical — researching and solving","Getting things organized and done","Justice and governance","Noticing details others miss","Explaining things clearly","Job stability and security"],
    aiImpact: { level: "automating", summary: "AI is handling legal research and document review at scale, shrinking entry-level paralegal roles — paralegals who specialize in complex litigation support, client management, and compliance are insulated." } },

  // ── APPLIED TECHNOLOGY ──
  { name: "Aviation / Aeronautics", salaryRange: "$65k–$200k+", jobOutlook: "Excellent",
    careers: ["Commercial Pilot","Aviation Manager","Air Traffic Controller","Flight Operations Specialist"],
    tags: ["Building or fixing things","Solving puzzles or math","Science (bio, chem, physics)","Hands-on — making, building, doing","Technical know-how","Job stability and security","High earning potential","Staying calm and problem-solving","Noticing details others miss"],
    aiImpact: { level: "changing", summary: "Autonomous systems are emerging in aviation, but certified pilots and aviation managers are in severe shortage — airlines are offering signing bonuses and fast-track programs to attract qualified candidates." } },

  // ── HUMANITIES ADDITIONS ──
  { name: "Religious Studies / Theology", salaryRange: "$40k–$80k", jobOutlook: "Stable", wild: true,
    careers: ["Clergy","Chaplain","Nonprofit Leader","Counselor","Academic Researcher"],
    tags: ["Reading or writing","Talking with and helping people","History / Social Studies","Psychology / Sociology","Making a difference","Human creativity and culture","Making people feel heard","Explaining things clearly","Education and opportunity","Justice and governance"],
    aiImpact: { level: "changing", summary: "Religious and ethical reasoning are increasingly valued as AI raises profound questions about meaning, consciousness, and morality — theology graduates are being sought by tech ethics boards and nonprofit organizations." } },
  { name: "Child & Family Studies", salaryRange: "$35k–$75k", jobOutlook: "Strong",
    careers: ["Family Services Coordinator","Child Life Specialist","Parent Educator","Policy Advocate"],
    tags: ["Talking with and helping people","Psychology / Sociology","Social — collaborating and teaching","Making a difference","Education and opportunity","Mental health and well-being","Making people feel heard","Poverty and inequality","Staying calm and problem-solving"],
    aiImpact: { level: "accelerates", summary: "AI screening tools are helping identify at-risk families earlier, but the relationship-based intervention work at the core of child and family services is irreplaceably human." } },
];
...
function scoreMajors(answers) {
  ...
  return chosen.map((s, i) => {
    ...
    return {
      ...
      aiImpact: m.aiImpact || { level: "changing", summary: "AI is reshaping this field — graduates who understand how to work alongside AI tools will have a significant advantage." },
      videoQueries: [
